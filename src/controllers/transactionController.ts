...
export const getHistoryPayouts = async (req: CustomRequest, res: Response, next: NextFunction) => {
  try {
...
export const getBalance = async (req: CustomRequest, res: Response, next: NextFunction) => {
  try {
...
export const createWithdraw = async (req: CustomRequest, res: Response, next: NextFunction) => {
  try {
    ...
    return res.json({
      success: true,
      message: "Succes create withdraw ",
      data
    });
  } catch (error) {
    next(error);
